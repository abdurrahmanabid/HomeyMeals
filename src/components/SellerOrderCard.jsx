...
const OrderedCard = () => {
  ...
  return (
    <section className="w-">
      <div className="m-4 mx-auto max-w-screen-lg rounded-md border border-gray-100 text-gray-600 shadow-md bg-white ">
        <div className="relative flex h-full flex-col text-gray-600 md:flex-row">
          ...
          <div className="mx-auto flex items-center px-5 pt-1 md:p-8">
            <img
              className="block h-auto max-w-96 min-w-96 rounded-md shadow-lg"
              src={data.imageSrc}
              alt="Shop image"
            />
          </div>
